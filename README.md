...
This demo sample explains how to underline the header text of columns in the Xamarin DataGrid (SfDataGrid) using practical, production-ready techniques that work across Android, iOS, and UWP.
